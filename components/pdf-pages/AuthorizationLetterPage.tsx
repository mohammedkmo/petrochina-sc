    ...
    return (
        <div className="w-[210mm] h-[297mm] mx-auto p-[20mm_15mm] break-after-page relative">
            ...
            <div className="mb-4 text-xs leading-relaxed arabic" dir="rtl">
                نحن شركة (<span className="mx-1 font-bold">{data.companyNameArabic || ''}</span>) المتعاقدون مع شركة (<span className="mx-1 font-bold">{data.contractedWithArabic || ''}</span>) بموجب العقد رقم (<span className="mx-1 font-bold" dir='ltr'>{data.contractNumber || ''}</span>) نخول السيد / السيدة (<span className="mx-1 font-bold">{data.authorizedPersonNameArabic || ''}</span>) حامل الهوية رقم (<span className="mx-1 font-bold" dir='ltr'>{data.authorizedPersonId || ''}</span>) بتمثيل شركتنا أمام مكتبكم الموقر في جميع الأمور المتعلقة بالتصاريح الأمنية، بما في ذلك تقديم الطلبات ومتابعتها واستلام الموافقات نيابة عنا.<br /><br />
